...
//                "-p123", "base1","test", "--single-transaction","-q","--default-character-set=utf8mb4",
// "--hex-blob","--where=(_slot>=100 and _slot<=1000) or (_slot>=2000 and _slot <=100000)", "--master-data=1",
// "-Tc:\\999"
