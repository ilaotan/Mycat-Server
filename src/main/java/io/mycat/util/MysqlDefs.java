...
public final class MysqlDefs {
    ...
    static int mysqlToJavaType(String mysqlType) {
        ...
        else if ("TINYINT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_TINY);
        }
        else if ("SMALLINT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_SHORT);
        }
        else if ("MEDIUMINT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_INT24);
        }
        else if ("INT".equalsIgnoreCase(mysqlType) || "INTEGER".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            // $NON-NLS-2$
            return mysqlToJavaType(FIELD_TYPE_LONG);
        }
        else if ("BIGINT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_LONGLONG);
        }
        else if ("INT24".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_INT24);
        }
        else if ("REAL".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_DOUBLE);
        }
        else if ("FLOAT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_FLOAT);
        }
        else if ("DECIMAL".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_DECIMAL);
        }
        else if ("NUMERIC".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_DECIMAL);
        }
        else if ("DOUBLE".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_DOUBLE);
        }
        else if ("CHAR".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_STRING);
        }
        else if ("VARCHAR".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_VAR_STRING);
        }
        else if ("DATE".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_DATE);
        }
        else if ("TIME".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_TIME);
        }
        else if ("YEAR".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_YEAR);
        }
        else if ("TIMESTAMP".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_TIMESTAMP);
        }
        else if ("DATETIME".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_DATETIME);
        }
        else if ("TINYBLOB".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.BINARY;
        }
        else if ("BLOB".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.LONGVARBINARY;
        }
        else if ("MEDIUMBLOB".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.LONGVARBINARY;
        }
        else if ("LONGBLOB".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.LONGVARBINARY;
        }
        else if ("TINYTEXT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.VARCHAR;
        }
        else if ("TEXT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.LONGVARCHAR;
        }
        else if ("MEDIUMTEXT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.LONGVARCHAR;
        }
        else if ("LONGTEXT".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return java.sql.Types.LONGVARCHAR;
        }
        else if ("ENUM".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
            return mysqlToJavaType(FIELD_TYPE_ENUM);
        }
        else if ("SET".equalsIgnoreCase(mysqlType)) { //$NON-NLS-1$
    ...
    static final void appendJdbcTypeMappingQuery(StringBuffer buf,
        ...
        while (mysqlTypes.hasNext()) {
            ...
            if ("DOUBLE".equalsIgnoreCase(mysqlTypeName)
                    || "FLOAT".equalsIgnoreCase(mysqlTypeName)
                    || "DECIMAL".equalsIgnoreCase(mysqlTypeName)
