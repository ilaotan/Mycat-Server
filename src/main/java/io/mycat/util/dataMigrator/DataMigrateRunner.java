...
public class DataMigrateRunner implements Runnable {
    ...
    public DataMigrateRunner(TableMigrateInfo table, DataNode src, DataNode target, String tableName, File
            conditionFile) {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println(table.getSchemaAndTableName() + " " + src.getName() + "->" + target.getName() + " " +
