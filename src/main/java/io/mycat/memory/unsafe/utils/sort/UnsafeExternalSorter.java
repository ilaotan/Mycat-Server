...
public final class UnsafeExternalSorter extends MemoryConsumer {
    ...
    public static UnsafeExternalSorter create(
        ...
        return new UnsafeExternalSorter(dataNodeMemoryManager, blockManager, serializerManager, recordComparator,
                prefixComparator, initialSize, pageSizeBytes, null,
    ...
    private UnsafeExternalSorter(
        ...
        if (existingInMemorySorter == null) {
            this.inMemSorter = new UnsafeInMemorySorter(
                    this, dataNodeMemoryManager, recordComparator, prefixComparator, initialSize, canUseRadixSort,
                    enableSort);
        }
        else {
    ...
    public long spill(long size, MemoryConsumer trigger) throws IOException {
        ...
        logger.info("Thread" + Thread.currentThread().getId() + " spilling sort data of " + JavaUtils.bytesToString
                (getMemoryUsage())
        ...
        if (inMemSorter.numRecords() > 0) {
             ...
             */
            final UnsafeSorterSpillWriter spillWriter = new UnsafeSorterSpillWriter(blockManager,
                    fileBufferSizeBytes,/**writeMetrics,*/inMemSorter.numRecords());
