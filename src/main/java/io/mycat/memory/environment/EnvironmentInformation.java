...
public class EnvironmentInformation {
    ...
    public static RevisionInformation getRevisionInformation() {
        ...
        try (InputStream propFile = EnvironmentInformation.class.getClassLoader().getResourceAsStream(".version" +
                ".properties")) {
            if (propFile != null) {
    ...
    public static String getJvmVersion() {
        try {
            ...
            return bean.getVmName() + " - " + bean.getVmVendor() + " - " + bean.getSpecVersion() + '/' + bean
                    .getVmVersion();
        }
        catch (Throwable t) {
            return UNKNOWN;
