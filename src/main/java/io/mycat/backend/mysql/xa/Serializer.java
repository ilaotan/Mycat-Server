...
public class Serializer {
    ...
    public String toJSON(CoordinatorLogEntry coordinatorLogEntry) {
        ...
        strBuilder.append(QUOTE).append("id").append(QUOTE).append(":").append(QUOTE).append(coordinatorLogEntry.id)
                .append(QUOTE);
        strBuilder.append(PROPERTY_SEPARATOR);
        //strBuilder.append(QUOTE).append("wasCommitted").append(QUOTE).append(":").append(coordinatorLogEntry
        // .wasCommitted);
        //strBuilder.append(PROPERTY_SEPARATOR);
        ...
        if (coordinatorLogEntry.participants.length > 0) {
            ...
            for (ParticipantLogEntry participantLogEntry : coordinatorLogEntry.participants) {
                ...
                strBuilder.append(START_OBJECT);
                strBuilder.append(QUOTE).append("uri").append(QUOTE).append(":").append(QUOTE).append
                        (participantLogEntry.uri).append(QUOTE);
                strBuilder.append(PROPERTY_SEPARATOR);
                strBuilder.append(QUOTE).append("state").append(QUOTE).append(":").append(QUOTE).append
                        (participantLogEntry.txState).append(QUOTE);
                strBuilder.append(PROPERTY_SEPARATOR);
                strBuilder.append(QUOTE).append("expires").append(QUOTE).append(":").append(participantLogEntry
                        .expires);
                if (participantLogEntry.resourceName != null) {
                    strBuilder.append(PROPERTY_SEPARATOR);
                    strBuilder.append(QUOTE).append("resourceName").append(QUOTE).append(":").append(QUOTE).append
                            (participantLogEntry.resourceName).append(QUOTE);
                }
