...
public class Deserializer {
    ...
    public CoordinatorLogEntry fromJSON(String coordinatorLogEntryStr) throws DeserialisationException {
        try {
            ...
            CoordinatorLogEntry actual = new CoordinatorLogEntry(header.get("id"), Boolean.valueOf(header.get
                    ("wasCommitted")), participantLogEntries, header.get("superiorCoordinatorId"));
            return actual;
        }
    ...
    ParticipantLogEntry recreateParticipantLogEntry(String coordinatorId,
        ...
        ParticipantLogEntry actual = new ParticipantLogEntry(coordinatorId,
                content.get("uri"), Long.valueOf(content.get("expires")), content.get("resourceName"), Integer
                .parseInt(content.get("state")));
        return actual;
    }
