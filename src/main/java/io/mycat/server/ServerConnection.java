...
public class ServerConnection extends FrontendConnection {
    ...
    public void execute(String sql, int type) {
        ...
        if (ServerParse.SELECT == type && sql.contains(" INFORMATION_SCHEMA.PROFILING ") && sql.contains("CONCAT" +
                "(ROUND(SUM(DURATION)/")) {
    ...
    private boolean isNormalSql(int type) {
        return ServerParse.SELECT == type || ServerParse.INSERT == type || ServerParse.UPDATE == type || ServerParse
                .DELETE == type || ServerParse.DDL == type;
    }
