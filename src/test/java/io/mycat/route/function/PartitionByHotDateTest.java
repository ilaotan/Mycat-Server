...
public class PartitionByHotDateTest {
    ...
    public void test() {
        ...
        cDate.add(Calendar.DATE, -5);
        System.err.println(dateFormat.format(cDate.getTime()));
        Assert.assertEquals(true, 0 == partition.calculateRange(dateFormat.format(cDate.getTime()), dateFormat.format
        ...
        Assert.assertEquals(true, 0 == partition.calculateRange(dateFormat.format(cDate.getTime()), dateFormat.format
                (Calendar.getInstance().getTime()))[0]);
        Assert.assertEquals(true, 1 == partition.calculateRange(dateFormat.format(cDate.getTime()), dateFormat.format
                (Calendar.getInstance().getTime()))[1]);
        Assert.assertEquals(true, 2 == partition.calculateRange(dateFormat.format(cDate.getTime()), dateFormat.format
