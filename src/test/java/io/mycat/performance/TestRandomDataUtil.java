...
public class TestRandomDataUtil {
    ...
    public void testParselRandVarTemplateString() throws Exception {
        LinkedList<StringItem> result = RandomDataValueUtil.parselRandVarTemplateString("${date(yyyy-MM-dd HH " +
                "[2014-2015]y-[1-6]M-[1-31]d-[7-21]H-[0-59]m-[5-33]s-[111-990]S)}");
