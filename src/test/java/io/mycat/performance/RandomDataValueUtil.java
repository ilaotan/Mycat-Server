 ...
 * such as
 * values ('$date{yyyyMMddHHmmsss-[2014-2015]y}/psn$date{yyyy}s/$int(0-9999)/16767:20725','$char(2,0-99) OPP_$enum
 * (BJ,SH,GZ,SZ)_$int(0-9)',$int(10,11),$int(400,420,500,600,800),$int(0-1000),$int(0-100),Sint(0-10),$int(0-99),
 * '201408040028317067b41c0db-4a93-4360-9eb4-e159d1dbef45',$phone,2,2014071715,2315998,1397,152317998,1395,'0000');
 *
 * @author wuzhih
 */
...
public class RandomDataValueUtil {
     ...
     * ',${int(10,11)},$int(400,420,500,600,800),$int(0-1000),$int(0-100),$int(0-10),$int(0-99),
     * '201408040028317067b41c0db-4a93-4360-9eb4-e159d1
    ...
    public static void main(String[] args) throws Exception {
        String sqlTemplate = "insert into opp_call (logthread, instanceid,callresult,partner, app_id,api_id," +
                "apiversion,format,token , phone,calltype, calldate,callminutes,callcost,ecipcalltime,ecipcallcost ," +
                "respcode) values ('${date(yyyyMMddHHmmssSSS-[2014-2015]y)}/psn2002s/${int(0-9999)}/${int(1111-9999)" +
                "}:20725','${char([0-9]2:2)} OPP_${enum(BJ,SH,WU,GZ)}_1',10,${int(10-999)},${int(10-99)},100,3,15," +
                "'${date(yyyyMMddHHmmssSSS-[2014-2015]y}${char([a-f,0-9]8:8)}-${char([a-f,0-9]4:4)}-${char([0-9]4:4)" +
                "}-9eb4-${char([a-f,0-9]12:12)}',${phone(139-189)},2,${date(yyyyMMddHH-[2014-2015]y},2315998,1397," +
                "${date(HHmmssSSS)},${int(100-1000)},'${enum(0000,0001,0002)}');";
...
class StringItemFactory {
    private static final Map<String, Class<? extends StringItem>> strItemsMap = new HashMap<String, Class<? extends
            StringItem>>();
