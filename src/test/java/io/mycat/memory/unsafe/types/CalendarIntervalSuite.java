...
public class CalendarIntervalSuite {
    ...
    public void toStringTest() {
        ...
        i = new CalendarInterval(0, -3 * CalendarInterval.MICROS_PER_WEEK - 13 * CalendarInterval.MICROS_PER_HOUR -
                123);
        assertEquals("interval -3 weeks -13 hours -123 microseconds", i.toString());

        i = new CalendarInterval(34, 3 * CalendarInterval.MICROS_PER_WEEK + 13 * CalendarInterval.MICROS_PER_HOUR +
                123);
